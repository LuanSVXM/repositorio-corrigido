...
const entrada = false;
if (entrada === false) {
    document.addEventListener('keydown', function rodar(e) {
        ...
        if (e.keyCode === 13 && mover[0] > 0) {
            ...
            document.querySelectorAll('.F' +(mover[0]))[mover[1]].children[0]
                .classList.add('sc');
        }
        if (e.keyCode === 13 && enter === false) {
            const number = document.querySelectorAll('.sc')[0]
        ...
        if (e.keyCode === 40 && enter === false) {
            ...
            document.querySelectorAll('.F' + (mover[0]))[mover[1]]
                .children[0].classList.add('sc');
        }
        ...
        if (e.keyCode === 27 && enter === false) {
            ...
            document.querySelectorAll('.F' + (mover[0]))
                .forEach(function(td) {
